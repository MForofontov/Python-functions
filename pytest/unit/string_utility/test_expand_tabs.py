...
def test_expand_tabs_default_tabsize() -> None:
    """
    Test the expand_tabs function with the default tab size (4 spaces).
    """
...
def test_expand_tabs_custom_tabsize() -> None:
    ...
    assert expand_tabs("hello\tworld", 8) == "hello        world", "Failed on custom tab size"
...
def test_expand_tabs_negative_tabsize() -> None:
    """
    Test the expand_tabs function with a negative tab size.
    """
