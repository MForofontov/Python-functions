...
def test_env_var_not_set(monkeypatch, capsys):
    """
    Test case 3: Environment variable is not set
    """
    # Test case 3: Environment variable is not set
...
def test_env_var_required_not_set(monkeypatch):
    """
    Test case 5: Required environment variable is not set
    """
    # Test case 5: Required environment variable is not set
    monkeypatch.delenv('TEST_ENV_VAR', raising=False)
...
def test_env_var_type_conversion(monkeypatch, capsys):
    """
    Test case 7: Environment variable type conversion
    """
    # Test case 7: Environment variable type conversion
...
def test_env_var_invalid_type_conversion(monkeypatch):
    """
    Test case 9: Environment variable type conversion
    """
    # Test case 9: Environment variable type conversion
...
def test_invalid_var_type():
    """
    Test case 13: Invalid var_type (not a type)
    """
    # Test case 13: Invalid var_type (not a type)
...
def test_invalid_custom_message():
    """
    Test case 14: Invalid custom_message (not a string or None)
    """
    # Test case 14: Invalid custom_message (not a string or None)
...
def test_invalid_var_name_with_logger(caplog):
    """
    Test case 15: Invalid var_name (not a non-empty string) with logger
    """
    with caplog.at_level(logging.ERROR):
...
def test_invalid_required_with_logger(caplog):
    """
    Test case 16: Invalid required (not a boolean) with logger
    """
    with caplog.at_level(logging.ERROR):
...
def test_invalid_var_type_with_logger(caplog):
    """
    Test case 17: Invalid var_type (not a type) with logger
    """
    with caplog.at_level(logging.ERROR):
...
def test_invalid_custom_message_with_logger(caplog):
    """
    Test case 18: Invalid custom_message (not a string or None) with logger
    """
    with caplog.at_level(logging.ERROR):
