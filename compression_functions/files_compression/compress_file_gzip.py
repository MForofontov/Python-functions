...
def compress_file_gzip(input_file: str, output_gzip: str) -> None:
    """
    ...
    ------
    TypeError
        If input_file or output_gzip is not a string.
    FileNotFoundError
    ...
    if not isinstance(output_gzip, str):
        raise TypeError("output_gzip must be a string")
